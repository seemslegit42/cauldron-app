...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={cn(
        'dark:bg-boxdark absolute top-0 left-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-gray-800 duration-300 ease-linear lg:static lg:translate-x-0',
        {
    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  cn(
                    'group text-bodydark1 dark:hover:bg-meta-4 relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out hover:bg-gray-700',
                    {
                      'dark:bg-meta-4 bg-gray-700': isActive,
                    }
                  )
                }
              >
          ...
          {/* <!-- Others Group --> */}
          <div>
            <h3 className="text-bodydark2 mb-4 ml-4 text-sm font-semibold">Extra Components</h3>
                    ...
                    <React.Fragment>
                      <NavLink
                        ...
                        className={cn(
                          'group text-bodydark1 dark:hover:bg-meta-4 relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out hover:bg-gray-700',
                          {
                            'dark:bg-meta-4 bg-gray-700': pathname.includes('forms'),
                          }
                        )}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        ...
                        Forms
                        <svg
                          className={cn('absolute top-1/2 right-4 -translate-y-1/2 fill-current', {
                            'rotate-180': open,
                          })}
                          width="20"
                          height="20"
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              ...
                              className={({ isActive }) =>
                                cn(
                                  'group text-bodydark2 relative flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out hover:text-white',
                                  { '!text-white': isActive }
                                )
                              }
                            >
                    ...
                    <React.Fragment>
                      <NavLink
                        ...
                        className={cn(
                          'group text-bodydark1 dark:hover:bg-meta-4 relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out hover:bg-gray-700',
                          {
                            'dark:bg-meta-4 bg-gray-700': pathname.includes('ui'),
                          }
                        )}
                        onClick={(e) => {
                          e.preventDefault();
