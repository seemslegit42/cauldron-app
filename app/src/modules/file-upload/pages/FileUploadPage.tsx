  ...
  return (
    <div className="py-10 lg:mt-10">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="my-8 rounded-3xl border border-gray-900/10 dark:border-gray-100/10">
          <div className="mx-auto my-10 space-y-10 px-4 py-8 sm:max-w-lg">
            <form onSubmit={handleUpload} className="flex flex-col gap-2">
              ...
              <button
                ...
                className="relative min-w-[7rem] rounded-md bg-yellow-50 px-4 py-2 font-medium text-gray-800/90 shadow-md ring-1 ring-slate-200 duration-200 ease-in-out ring-inset hover:bg-yellow-100 hover:shadow-none focus:shadow-none focus:outline-none disabled:cursor-progress"
              >
                {uploadProgressPercent > 0 ? (
                  <>
                    ...
                    <div
                      ...
                      aria-valuemin={0}
                      aria-valuemax={100}
                      className="absolute bottom-0 left-0 h-1 rounded-b-md bg-yellow-500 transition-all duration-300 ease-in-out"
                ...
                allUserFiles.data.map((file: File) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="min-w-[7rem] rounded-md bg-purple-50 px-2 py-1 text-sm text-gray-800/90 shadow-md ring-1 ring-slate-200 duration-200 ease-in-out ring-inset hover:bg-purple-100 hover:shadow-none focus:shadow-none focus:outline-none disabled:cursor-not-allowed"
                    >
