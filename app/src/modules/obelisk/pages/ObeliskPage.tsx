...
const ObeliskPage = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-900 text-white">
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 transform bg-gray-800 transition duration-300 ease-in-out ${
        ...
        <div className="flex h-full flex-col">
          ...
          <nav className="mt-8 flex-1 space-y-2 px-4">
            ...
            <Link
              to="/obelisk/sources"
              className={`flex items-center rounded-lg px-4 py-2 ${
                isActive('/sources') ? 'bg-gray-700 text-white' : 'text-gray-300 hover:bg-gray-700'
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <Link
              to="/obelisk/findings"
              className={`flex items-center rounded-lg px-4 py-2 ${
                isActive('/findings') ? 'bg-gray-700 text-white' : 'text-gray-300 hover:bg-gray-700'
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <Link
              to="/obelisk/alerts"
              className={`flex items-center rounded-lg px-4 py-2 ${
                isActive('/alerts') ? 'bg-gray-700 text-white' : 'text-gray-300 hover:bg-gray-700'
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <Link
              to="/obelisk/webhooks"
              className={`flex items-center rounded-lg px-4 py-2 ${
                isActive('/webhooks') ? 'bg-gray-700 text-white' : 'text-gray-300 hover:bg-gray-700'
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <Link
              to="/obelisk/settings"
              className={`flex items-center rounded-lg px-4 py-2 ${
                isActive('/settings') ? 'bg-gray-700 text-white' : 'text-gray-300 hover:bg-gray-700'
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="mt-auto p-4">
            <div className="rounded-lg bg-gray-700 p-4">
              <h3 className="text-sm font-medium text-white">OSINT Status</h3>
              <div className="mt-2 flex items-center">
                <div className="h-2.5 w-2.5 rounded-full bg-green-400"></div>
                <span className="ml-2 text-sm text-gray-300">Active</span>
              </div>
              <p className="mt-2 text-xs text-gray-400">
                Obelisk is actively monitoring your configured sources.
              </p>
            </div>
          </div>
        </div>
        ...
        <header className="bg-gray-800 shadow-md">
          <div className="flex h-16 items-center justify-between px-4">
            <div className="flex items-center">
              ...
              <h1 className="ml-4 text-xl font-bold text-white lg:ml-0">Obelisk OSINT Engine</h1>
            </div>
            <div className="flex items-center space-x-4">
              <button className="rounded-lg bg-gray-700 px-3 py-1 text-sm text-white hover:bg-gray-600">
                New Scan
              </button>
              <button className="rounded-full bg-gray-700 p-2 text-gray-300 hover:bg-gray-600">
